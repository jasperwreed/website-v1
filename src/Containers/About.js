...
const About = () => {
    return (
        <div className='full-view'>
            ...
            <p>
                 + Powerful communication and leadership skills established 
                 through team-based sports and academic projects.
            </p>
            <p>
                + Former Vermont State Long Jump Record Holder and nine-time state champion. 
                (4 x Long Jump Champion, 2 x 100 Meter Champion, 2 x Triple Jump Champion, 1 x 200 Meter Champion)
            </p>
            <p>
                Looking for opportunities to create mutually beneficial partnerships that drive growth on both sides of the relationship, specifically in the world of tech/digital. Want to connect? Feel free to email me at jasperwreed@protonmail.com.
            </p> */}
        </div>
    )
}
